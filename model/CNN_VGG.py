'''
VGG feature extraction using tensorflow with pre-trained model
'''
...
if __name__ == '__main__':
    ...
    img1 = imread('../data/Flicker8k_Dataset/2513260012_03d33305cf.jpg', mode='RGB')
